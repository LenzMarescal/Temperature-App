...
function App () {
  ...
  return (
    <div
      className={
        typeof apparence != 'undefined'
          ? apparence === 'Rain'
            ? 'app-rain'
            : apparence === 'Clear'
            ? 'app-bleu'
            : apparence === 'Thunderstorm'
            ? 'app-thunder'
            : apparence === 'Drizzle'
            ? 'app-drizz'
            : apparence === 'Snow'
      ...
      <main className='app-main'>
        ...
        <div className='app-main-result'>
          ...
          <img
            alt={
              darkness(Int) === true
                ? "Cette icône indique qu'il fait nuit"
                : "Cette icône indique qu'il fait jour"
            }
        ...
        <div className='app-main-result-temps'>
          <div className='app-main-result-temps-C'>{Math.round(meteo)} °C</div>
          <div className='app-main-result-temps-description'>
            The sky is : {apparence}
          </div>
        </div>
      </main>
    </div>
